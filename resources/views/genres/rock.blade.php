...
<div class="main">
	<div class="container">
	<a href="{{ url('music_front')}}" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Home</a>
		<div class="row">
			<div class="col-md-12">
				<h3>New Releasess</h3>
			</div>
	...
	<script>
		...
		const ap = new APlayer({
		    ...
		    audio: [
		    {
		        ...
		        artist: 'Artist Name',
		        url: '../track/02_bring_me_the_horizon-happy_song-utp.mp3',
		        cover: 'https://images.pexels.com/photos/1699161/pexels-photo-1699161.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500'
		    },
			{
		        name: 'Happy Song',  // SONG NAME
		        artist: 'Bring Me The Horizon', //ARTIST NAME
		        url: '../track/02_bring_me_the_horizon-happy_song-utp.mp3', // PATH NAME AND SONG URL
